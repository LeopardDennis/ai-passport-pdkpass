...
const pdkpass_race_t pdkpass_races[] = {
    ...
    { 1281, 1774767600, 0xE84C84, 5807, 3, 53, "JAPAN", "SUZUKA", "27-29 MAR", "FP1   27 MAR 10:30", "QUALI 28 MAR 14:00", "RACE  29 MAR 13:00", "Japan" },
    ...
    { 1286, 1780844400, 0x34C5D1, 3337, 6, 78, "MONACO", "MONACO", "05-07 JUN", "FP1   05 JUN 19:30", "QUALI 06 JUN 22:00", "RACE  07 JUN 21:00", "Monaco" },
    { 1287, 1781449200, 0xFF7A00, 4657, 7, 66, "SPAIN", "BARCELONA", "12-14 JUN", "FP1   12 JUN 19:30", "QUALI 13 JUN 22:00", "RACE  14 JUN 21:00", "Spain" },
    { 1288, 1782658800, 0xE32636, 4318, 8, 71, "AUSTRIA", "SPIELBERG", "26-28 JUN", "FP1   26 JUN 19:30", "QUALI 27 JUN 22:00", "RACE  28 JUN 21:00", "Austria" },
    ...
    { 1290, 1784473200, 0xF0C05A, 7004, 10, 44, "BELGIUM", "SPA-FRANCORCHAMPS", "17-19 JUL", "FP1   17 JUL 19:30", "QUALI 18 JUL 22:00", "RACE  19 JUL 21:00", "Belgium" },
    ...
    { 1292, 1787497200, 0xE85D04, 4259, 12, 72, "NETHERLANDS", "ZANDVOORT", "21-23 AUG", "FP1   21 AUG 18:30", "SPR Q 21 AUG 22:30", "RACE  23 AUG 21:00", "Netherlands" },
...
const pdkpass_driver_t pdkpass_drivers[] = {
    ...
    { 0xFF8700, 1590,  4,  1, "NOR", "NORRIS",     "MCLAREN",      "LANDO" },
    { 0xE32636, 1550,  5, 16, "LEC", "LECLERC",    "FERRARI",      "CHARLES" },
    { 0x3671C6, 1120,  6,  3, "VER", "VERSTAPPEN", "RED BULL",     "MAX" },
    { 0xFF8700, 1040,  7, 81, "PIA", "PIASTRI",    "MCLAREN",      "OSCAR" },
    { 0x3671C6,  680,  8,  6, "HAD", "HADJAR",     "RED BULL",     "ISACK" },
    { 0x3671C6,  490,  9, 30, "LAW", "LAWSON",     "RED BULL",     "LIAM" },
    { 0x2293D1,  440, 10, 10, "GAS", "GASLY",      "ALPINE",       "PIERRE" },
    { 0x6692FF,  230, 11, 41, "LIN", "LINDBLAD",   "RACING BULLS", "ARVID" },
    { 0x2293D1,  190, 12, 43, "COL", "COLAPINTO",  "ALPINE",       "FRANCO" },
    { 0xB6BABD,  180, 13, 87, "BEA", "BEARMAN",    "HAAS",         "OLIVER" },
    { 0xF50537,  100, 14,  5, "BOR", "BORTOLETO",  "AUDI",         "GABRIEL" },
    { 0xF50537,   60, 15, 27, "HUL", "HULKENBERG", "AUDI",         "NICO" },
    { 0x64C4FF,   60, 16, 55, "SAI", "SAINZ",      "WILLIAMS",     "CARLOS" },
    { 0x64C4FF,   50, 17, 23, "ALB", "ALBON",      "WILLIAMS",     "ALEXANDER" },
    { 0xB6BABD,   30, 18, 31, "OCO", "OCON",       "HAAS",         "ESTEBAN" },
    { 0x229971,   30, 19, 14, "ALO", "ALONSO",     "ASTON MARTIN", "FERNANDO" },
    { 0x6692FF,    0, 20, 22, "TSU", "TSUNODA",    "RACING BULLS", "YUKI" },
    { 0x229971,    0, 21, 18, "STR", "STROLL",     "ASTON MARTIN", "LANCE" },
    { 0x1B2D57,    0, 22, 77, "BOT", "BOTTAS",     "CADILLAC",     "VALTTERI" },
