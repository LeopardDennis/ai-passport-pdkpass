...
- Replaced battery text with a rounded, level-filled icon and inset percentage
  digits; unknown readings show an empty outline. At 0–20% the digits and remaining fill
  use a red warning on a light interior; 21–100% uses the normal theme color.
